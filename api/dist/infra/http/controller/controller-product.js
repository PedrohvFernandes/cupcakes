...
const get_all_products_service_1 = require("../services/get-all-products-service");
...
class ControllerProducts {
    async GetAllProductsController(request, response) {
        ...
        const result = await new get_all_products_service_1.GetAllProductsService(ProductRepositoryStripe).execute();
